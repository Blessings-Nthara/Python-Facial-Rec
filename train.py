...
message = tk.Label(window, text="Face Recognition Attendance System with Deep Learning", bg="Black", fg="Silver", width=50,
                   height=3, font=('times', 30, 'bold'))

message.place(x=200, y=20)

lbl = tk.Label(window, text="Student Number", width=20, height=2, fg="white", bg="Black", font=('times', 15, ' bold '))
lbl.place(x=400, y=200)

txt = tk.Entry(window, width=20, bg="white", fg="Black", font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="First Name", width=20, fg="white", bg="Black", font=('times', 15, ' bold '))
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window, width=20, bg="white", fg="Black", font=('times', 15, ' bold '))
txt2.place(x=700, y=315)

#lbl3 = tk.Label(window, text="Last Name", width=20, fg="white", bg="Black", font=('times', 15, ' bold '))
...
lbl4 = tk.Label(window, text="Status: ", width=20, fg="red", bg="black", height=2,
                font=('times', 15, ' bold'))
lbl4.place(x=400, y=400)

message = tk.Label(window, text="", bg="black", fg="blue", width=20, height=1, activebackground="yellow",
                   font=('times', 15, ' bold '))
message.place(x=700, y=400)

lbl4 = tk.Label(window, text="Attendance : ", width=20, fg="red", bg="yellow", height=2,
                font=('times', 15, ' bold  underline'))
lbl4.place(x=400, y=650)

message2 = tk.Label(window, text="", fg="blue", bg="black", activeforeground="green", width=30, height=2,
                    font=('times', 15, ' bold '))
...
trackImg = tk.Button(window, text="Mark Attendance", command=TrackImages, fg="red", bg="yellow", width=20, height=3,
                     activebackground="Red", font=('times', 15, ' bold '))
